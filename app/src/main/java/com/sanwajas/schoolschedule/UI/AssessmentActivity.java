...
public class AssessmentActivity extends AppCompatActivity {
    ...
    private void loadRecycler() {
        ...
        List<AssessmentEntity> allClasses = repository.getmAllAssesments();
        RecyclerView recyclerView = findViewById(R.id.allAssessmentList);
        AssessmentAdapter assessmentAdapter = new AssessmentAdapter(this, allClasses);
    ...
    public void addAssessment(View view) {
        startActivity(new Intent(AssessmentActivity.this, AssessmentDetailActivity.class));
    }
}